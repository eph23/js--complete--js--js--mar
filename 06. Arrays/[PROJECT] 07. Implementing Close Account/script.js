...
btnLogin.addEventListener('click', function (event) {
  ...
  inputLoginPin.value = '';
  inputLoginUsername.getBoundingClientRect();
...
btnTransfer.addEventListener('click', function (event) {
  ...
  inputTransferAmount.getBoundingClientRect();
  inputTransferTo.getBoundingClientRect();
});
/* ******************************************** */
...
btnClose.addEventListener('click', function (event) {
  ...
  inputClosePin.value = '';
  inputCloseUsername.getBoundingClientRect();
  inputClosePin.getBoundingClientRect();
});
/* ******************************************** */
