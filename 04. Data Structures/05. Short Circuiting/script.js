...
// Short circuiting
// The OR (||) operator returns the first truthy value if available
console.log(3 || 'Eph');
console.log('' || 'Eph');
console.log(true || 0);
...
// The AND (&&) operator returns the first falsy value if available
console.log(0 && 'Eph');
console.log(7 && 'Eph');
console.log('Hello' && 23 && null && 'Ephraim');

restaurant.orderPizza &&
  restaurant.orderPizza('Mushrooms', 'Tomato', 'Spinach');
